...
export const locale: Locale = {
  ...
  seasons: {
    advent: {
      season: 'Mùa Vọng',
      weekday: '$t(weekdays:{{dow}}, capitalize) tuần $t(ordinals:{{week}}) Mùa Vọng',
      sunday: '$t(ordinals:{{week}}, capitalize) Chúa Nhật Mùa Vọng',
      privileged_weekday: '$t(months:11, capitalize) {{day}}',
    },

    christmas_time: {
      season: 'Mùa Giáng Sinh',
      day: '$t(weekdays:{{dow}}, capitalize) của lễ Giáng Sinh',
      octave: 'Ngày thứ {{count}}º trong Tuần Bát Nhật Giáng Sinh',
      second_sunday_after_christmas: 'Chúa Nhật II sau lễ Giáng Sinh',
      before_epiphany: '$t(months:0, capitalize) {{day}}',
      after_epiphany: '$t(weekdays:{{dow}}, capitalize) sau Lễ Hiển Linh',
    },

    ordinary_time: {
      season: 'Mùa Thường Niên',
      weekday: '$t(weekdays:{{dow}}, capitalize) tuần $t(ordinals:{{week}}) thường niên',
      sunday: 'Chúa Nhật $t(ordinals:{{week}}, capitalize) Thường Niên',
    },

    lent: {
      season: 'Mùa Chay',
      weekday: '$t(weekdays:{{dow}}, capitalize) tuần $t(ordinals:{{week}}) mùa chay',
      sunday: 'Chúa Nhật $t(ordinals:{{week}}, capitalize) Mùa Chay',
      day_after_ash_wed: '$t(weekdays:{{dow}}, capitalize) sau Lễ Tro',
      holy_week_day: '$t(weekdays:{{dow}}, capitalize) Tuần Thánh',
    },
    ...
    easter_time: {
      ...
      weekday: '$t(weekdays:{{dow}}, capitalize) tuần $t(ordinals:{{week}}) phục sinh',
      sunday: 'Chúa Nhật $t(ordinals:{{week}}, capitalize) Phục Sinh',
  ...
  names: {
    ...
    baptism_of_the_lord: 'Lễ Chúa Giêsu Chịu Phép Rửa',
    christ_the_king_sunday: 'Chúa Giêsu Kitô, Vua vũ trụ',
    christmas: 'Chúa giáng sinh',
    corpus_christi: 'Mình và Máu Thánh Chúa Kitô',
    divine_mercy_sunday: 'Chúa Nhật II Phục Sinh, Kính Lòng Thương Xót Chúa',
